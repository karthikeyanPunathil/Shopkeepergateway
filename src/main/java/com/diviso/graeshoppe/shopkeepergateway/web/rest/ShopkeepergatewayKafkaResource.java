...
@RestController
@RequestMapping("/api/shopkeepergateway-kafka")
public class ShopkeepergatewayKafkaResource {

    private final Logger log = LoggerFactory.getLogger(ShopkeepergatewayKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public ShopkeepergatewayKafkaResource(KafkaProperties kafkaProperties) {
